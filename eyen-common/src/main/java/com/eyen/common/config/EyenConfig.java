 ...
 */
@Component
@ConfigurationProperties(prefix = "yuwenbo")
public class EyenConfig {
    /**
     * 项目名称
     */
    private String name;
     ...
     * shiro不拦截url配置
     **/
    private List<String> shiroNotFilterUrl;
    ...
    public List<String> getShiroNotFilterUrl() {
        return shiroNotFilterUrl;
    }

    public void setShiroNotFilterUrl(List<String> shiroNotFilterUrl) {
        this.shiroNotFilterUrl = shiroNotFilterUrl;
    }
