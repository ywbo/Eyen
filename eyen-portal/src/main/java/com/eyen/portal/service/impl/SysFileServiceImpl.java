...
@Service
public class SysFileServiceImpl implements BaseService<SysFile, SysFileExample> {
    @Autowired
    ...
    public PageInfo<SysFile> list(Tablepar tablepar, String name) {
        ...
        List<SysFile> list = sysFileDao.selectByExample(testExample);
    ...
    public int updateByPrimaryKey(SysFile record) {
        //获取旧数据
        SysFile old_data = sysFileDao.selectByPrimaryKey(record.getId());
        //插入修改人id
        ...
        return sysFileDao.updateByPrimaryKey(old_data);
    }
    ...
    public int deleteByPrimaryKey(String ids) {
        ...
        return sysFileDao.deleteByExample(example);
    }
    ...
    public int updateByExampleSelective(SysFile record, SysFileExample example) {
        return sysFileDao.updateByExampleSelective(record, example);
    }

    @Override
    public int updateByExample(SysFile record, SysFileExample example) {
        return sysFileDao.updateByExample(record, example);
    }
    ...
    public long countByExample(SysFileExample example) {
        return sysFileDao.countByExample(example);
    }
