...
import com.eyen.common.utils.file.FileUploadUtils;
import com.eyen.common.utils.file.FileUtils;
...
public class CommonController {
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request) {
        try {
            ...
            String filePath = EyenGlobalConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception {
        try {
            // 上传文件路径
            String filePath = EyenGlobalConfig.getUploadPath();
            // 上传并返回新文件名称
    ...
    public void resourceDownload(String resource, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // 本地资源路径
            String localPath = EyenGlobalConfig.getProfile();
            // 数据库资源地址
